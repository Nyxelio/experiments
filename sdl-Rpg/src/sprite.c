...
void HandleSprites(struct s_lib_sprite *libsprite, struct s_map *map)
{
     ...
     {
        if(!libsprite->sprites[i].ispaused_anim)
        {
...
void SpriteStaticData(struct s_lib_sprite *libsprite)
{
     ...
     libsprite->sprites[0].surf=SDL_LoadBMP("./data/sprites/player.bmp");
     ...
     libsprite->sprites[1].surf=SDL_LoadBMP("./data/sprites/player.bmp");
     SDL_SetColorKey(libsprite->sprites[1].surf, SDL_SRCCOLORKEY,
     ...
     libsprite->sprites[1].anim[0].frame=
     ...
     libsprite->sprites[1].anim[1].frame=
     ...
     libsprite->sprites[1].anim[2].frame=
     ...
     libsprite->sprites[1].anim[3].frame=
