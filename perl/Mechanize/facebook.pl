...
my $link = "facebook.com/LDLC.com/app_441766419206825";
...
my $connected = $tree->findvalue('//a[title="Profil"]/span/');
print $connected."\n";
...
sleep(8);
print "appel jeu\n";
$m->follow_link( tag => 'a', id => 'participer', synchronize => 1 );
sleep(2);
print "ok\n";
...
sub Connexion
{
    ...
    #connexion OK
    $m->form_id('login_form');
    $m->field( email => 'datenshi33@gmail.com' );
    $m->field( pass => 'k3stnWM7' );
