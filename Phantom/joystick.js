var joystick = function(){
	...
	return{
		...
		draw: function(context){
			if (pressed == 1){	
				//base of joystick
				var grd = context.createRadialGradient(tempScreenPositionX-25, tempScreenPositionY-25, 25, tempScreenPositionX+25, tempScreenPositionY+25, 30);
				...
				//actual joystick
				var grd2 = context.createRadialGradient(tempDragPositionX-15, tempDragPositionY-15, 15, tempDragPositionX+15, tempDragPositionY+15, 20);
